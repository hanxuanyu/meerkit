const staticPaths = { overview: "/", monitors: "/monitors", statusBoard: "/status-board", inbox: "/notifications", notifications: "/notification-channels", plugins: "/plugins", logs: "/logs", settings: "/settings" };

...
function MonitorRecordsPanel({ monitor, descriptor, initialRecordID = "", onRecordRouteChange, onRecordsDeleted, refreshVersion = 0 }) {
  ...
  return <>
    ...
    {selectedRecord && <RecordDetailDialog record={selectedRecord} descriptor={selectedRecord.descriptor || descriptor} onClose={closeRecord} />}

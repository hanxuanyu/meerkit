...
export function MonitorDialog({ monitor, modules, channels, defaultTimezone, onClose, onSaved, onError }) {
  ...
  const [config, setConfig] = useState(() => monitor?.module_config || defaultModuleConfig[moduleType] || {});
  ...
  useEffect(() => { if (!monitor) setConfig(defaultModuleConfig[moduleType] || {}); }, [moduleType, monitor]);

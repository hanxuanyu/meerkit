...
import { Activity, AppWindow, Bell, ChartNoAxesColumnIncreasing, ChevronsRight, CircleX, Globe2, History, Inbox, Layers3, PackageOpen, RefreshCw, ScrollText, Settings2, X } from "lucide-react";
...
const tabDefinitions = {
  ...
  browser: { title: "浏览器", icon: AppWindow, closable: true },

...
func domInputAction() actionSpec {
	return newAction("dom.input", "填写控件", "设置输入框、文本域、下拉框或可编辑元素的值。", "dom", "DOM", "keyboard", "status", "tab_required", false, []sdk.ParameterDescriptor{
		{Key: "selector", Label: "CSS Selector", Description: "定位首个可填写或可编辑元素。", Type: sdk.ParameterCSSSelector, Required: true, Placeholder: "input[name=email]", FullWidth: true, SelectorCandidates: editableSelectorCandidates()},

...
func (a *APIServer) Router() http.Handler {
	...
	api.GET("/browser/targets", a.browserTargets)
	api.GET("/browser/debug/ws", a.streamBrowserDebug)
	...
	api.GET("/status-board/shares", a.listStatusBoardShares)
	api.POST("/status-board/shares", a.createStatusBoardShare)
	api.DELETE("/status-board/shares/:id", a.deleteStatusBoardShare)
	api.POST("/status-board/shares/:id/restore", a.restoreStatusBoardShare)
	api.DELETE("/status-board/shares/:id/permanent", a.permanentlyDeleteStatusBoardShare)
